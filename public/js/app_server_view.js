...
var app = new Vue({
    ...
    methods: {
        ...
        formatHumanSizes: function formatHumanSizes(bytes) {
        ...
        ifUnsavedChanges: function ifUnsavedChanges() {
        ...
        ifPanelOpenned: function ifPanelOpenned() {
            for (var i in this.panels) {
                if (this.panels[i] == true) return true;
            }
            return false;
        },
        updateInterval: function updateInterval(d) {
            this.interval = d;
        },
        updateDatetime: function updateDatetime(d) {
            this.datetime = d;
        },
        ...
        selectServer: function selectServer(id) {
        ...
        setNoficationSend: function setNoficationSend(action, notification_id) {
